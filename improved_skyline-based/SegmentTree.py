class SegmentTree:
    ...
    def _query(self, treeIndex, l, r, queryL, queryR):
        if l == queryL and r == queryR:
            return self._tree[treeIndex], treeIndex
        mid = l + (r - l) // 2
        ...
        if queryL >= mid + 1:
            ...
            left_result, left_index = self._query(leftTreeIndex, l, mid, queryL, mid)
            right_result, right_index = self._query(rightTreeIndex, mid + 1, r, mid + 1, queryR)
